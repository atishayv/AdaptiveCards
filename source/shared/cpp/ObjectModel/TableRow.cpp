...
{
    TableRow::TableRow() :
        BaseCardElement(CardElementType::TableRow), m_horizontalCellContentAlignment(HorizontalAlignment::Left),
        m_verticalCellContentAlignment(VerticalAlignment::Top), m_style(ContainerStyle::None)
    {
    }
    ...
    std::shared_ptr<BaseCardElement> TableRowParser::Deserialize(ParseContext& context, const Json::Value& json)
    {
        ...
        tableRow->SetCells(ParseUtil::GetElementCollection<TableCell>(false, context, json, AdaptiveCardSchemaKey::Cells, false, CardElementTypeToString(CardElementType::TableCell)));
